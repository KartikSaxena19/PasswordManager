...
const Manager = () => {
    ...
    const editPassword=(id) => {
        ...
        setform(passwordArray.filter(i=>i.id===id)[0])  //push item in the input blocks
        setPasswordArray(passwordArray.filter(item=>item.id!==id))  //delete the item  while editing than freshly save it
    }
